...
void addHouse()
{
    int i = 0;
        ...
        fstream myfile;
        myfile.open("C:/Users/Prof-Virus/Documents/house_storage.txt",ios::out|ios::app);
        while(i<1)
    {
...
void listHouses()
{
     int i = 0;
        ...
        fstream file1;
        file1.open("C:/Users/Prof-Virus/Documents/house_storage.txt",ios::in);
...
void searchHouse()
{
	...
	fstream myfile;
	myfile.open("C:/Users/Prof-Virus/Documents/house_storage.txt",ios::in);
	while(!myfile.eof())
    {
...
void deleteHouse()
{
	...
	cin>>way;
        ...
        fstream myfile;
	 	fstream search_file;
	 	myfile.open("C:/Users/Prof-Virus/Documents/house_storage.txt",ios::in);//read
	 	search_file.open("C:/Users/Prof-Virus/Documents/fake_storage.txt",ios::out);//write
        ...
        myfile.close();
		search_file.close();
        remove("C:/Users/Prof-Virus/Documents/house_storage.txt");
        rename("C:/Users/Prof-Virus/Documents/fake_storage.txt","C:/Users/Prof-Virus/Documents/house_storage.txt");
        hse.clear();
        if(flag == 0)
        {
